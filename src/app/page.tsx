...
const serviceTypes = [
  { number: "01", title: "Airport Transfer", description: "Prearranged airport pickup or drop-off with the trip details providers need to quote accurately.", detail: "Flight-aware request details", image: "/images/regia-service-airport-transfer.webp", alt: "Professional chauffeur welcoming an airport passenger beside a black sedan" },
  { number: "02", title: "Point-to-Point", description: "One scheduled transfer between an airport, hotel, home, office, venue, or other destination.", detail: "One pickup · One destination", image: "/images/regia-service-point-to-point.webp", alt: "Black executive sedan arriving at a Los Angeles hotel" },
  { number: "03", title: "Multiple Transfers", description: "Organize several independent transfers in one request, each with its own date, time, and route.", detail: "Multi-day and business schedules", image: "/images/regia-service-multiple-transfers.webp", alt: "Dark map showing multiple destinations connected by a planned route" },
  { number: "04", title: "Hourly Transportation", description: "Reserve a private vehicle for a continuous block of time when your schedule needs flexibility.", detail: "Flexible, time-based service", image: "/images/regia-service-hourly.webp", alt: "Professional chauffeur waiting beside a black full-size SUV" },
  { number: "05", title: "Long Distance", description: "Plan private transportation between cities or for a longer regional journey.", detail: "Intercity and regional travel", image: "/images/regia-service-long-distance.webp", alt: "Black premium SUV traveling along a Southern California coastal highway" },
  { number: "06", title: "Custom Transportation", description: "Describe an executive, VIP, or itinerary-specific request that needs a tailored quote.", detail: "Built around your requirements", image: "/images/regia-service-custom.webp", alt: "Chauffeur and transportation coordinator preparing for a VIP arrival" },
] as const;
