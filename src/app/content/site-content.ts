...
const faqItems = {
  ...
  cancellation: ["What if I need to cancel or change a confirmed ride?", "Cancellation and change terms may vary by the selected provider, timing, and trip type. Review the applicable terms before confirming and request changes as early as possible."],
